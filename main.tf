module "alb" {
  ...
  connection_logs                                              = try(local.connection_logs_local[each.key], var.alb_defaults.connection_logs, null)
  ...
  health_check_logs                                            = try(local.health_check_logs_local[each.key], var.alb_defaults.health_check_logs, null)
