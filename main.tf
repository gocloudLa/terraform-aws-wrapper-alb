module "alb" {
  ...
  listeners                        = try(each.value.listeners, var.alb_defaults.listeners, {})
  ...
  timeouts                         = try(each.value.timeouts, var.alb_defaults.time, {})
  ...
  access_logs                      = try(local.access_logs[each.key], var.alb_defaults.access_logs, {})
  ...
  ipam_pools                       = try(each.value.ipam_pools, var.alb_defaults.ipam_pools, {})

  # FEATURE VARIABLES
  additional_target_group_attachments                          = try(each.value.additional_target_group_attachments, var.alb_defaults.additional_target_group_attachments, {})
  ...
  connection_logs                                              = try(each.value.connection_logs, var.alb_defaults.connection_logs, {})
  ...
  minimum_load_balancer_capacity                               = try(each.value.minimum_load_balancer_capacity, var.alb_defaults.minimum_load_balancer_capacity, {})
